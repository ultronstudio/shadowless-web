          ...
          <td align="center">
            <div style="${baseStyles.container}">
              <div style="text-align:center;margin-bottom:24px;">
                <div style="display:inline-flex;width:68px;height:68px;border-radius:50%;border:1px solid rgba(138,11,11,0.4);background-color:rgba(138,11,11,0.15);align-items:center;justify-content:center;margin-bottom:18px;">
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="color:#8a0b0b;"></svg>
